...
public class IntegerWidget extends StringWidget {
    ...
    public IntegerWidget(final Context context, FormEntryPrompt prompt) {
        ...
        /*
         * after the user gave an answer
         * we save the answer in the disk and
         * assign the right color to the widget
         * that represent the question 
         */
        /*
         * mAnswer is an object inherited from QuestionAndStrignAnswerWidget.
		 * It is a EditText Android Widget, that represents the prompt for the answer.
         */
