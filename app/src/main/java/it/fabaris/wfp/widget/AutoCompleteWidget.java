...
public class AutoCompleteWidget extends QuestionWidget {
    ...
    private class AutoCompleteAdapter extends ArrayAdapter<String> implements Filterable {
        ...
        /**
         * add every answer to the possibles
         */
        @Override
        ...
        /**
         * @return number of all possible answer
         */
        @Override
        public int getCount() {
            return mItems.size();
        ...
        /**
         * @return the string value of the answer chosen
         */
        @Override
