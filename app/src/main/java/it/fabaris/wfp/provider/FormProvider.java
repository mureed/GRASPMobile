    ...
    public static class DatabaseHelper extends ODKSQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + FORMS_TABLE_NAME + " ("
                    ...
                    + FormsColumns.DISPLAY_NAME_INSTANCE + " text, " ////---------------------->LL 14-05-2014 in grasp db = saved_name_form, completed_by, submitted_by
                    ...
                    + FormsColumns.DATE + " integer not null, " // milliseconds  ---------------------------->LL 14-05-2014 in grasp db = saved_data
                    ...
                    //in grasp db saved_by, completed_by, submitted_by
                    + FormsColumns.ENUMERATORID + " text, "//LL 14-05-2014 added for the initialization of the adapters of the "new" "save" "completed" "submitted" lists's tabs

                    //in grasp db saved_id, completed_id, submitted_id
                    + FormsColumns.FORMNAMEANDXMLFORMID + " text, "//LL 14-05-2014 added for the initialization of the adapters of the "new" "save" "completed" "submitted" lists's tabs

                    // in grasp db completed_data
                    + FormsColumns.COMPLETATION_DATE + " text, "//LL 14-05-2014 added for the initialization of the adapters of the "completed"  list
                    // in grasp db  submitted_data
                    + FormsColumns.SUBMISSION_DATE + " text, "//LL 14-05-2014 added for the initialization of the adapters of the "submitted" list
